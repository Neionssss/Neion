...
object FreeCam {
    ...
    fun onUpdate(e: LivingUpdateEvent) {
        ...
        thePlayer.motionX = 0.0
        thePlayer.motionZ = 0.0
        val speed = Config.speedVaue
        if (mc.gameSettings.keyBindJump.isKeyDown) thePlayer.motionY += speed
        if (mc.gameSettings.keyBindSneak.isKeyDown) thePlayer.motionY -= speed
