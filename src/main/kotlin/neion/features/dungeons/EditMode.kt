...
object PreBlocks: Module("Pre Ghost Blocks", category = Category.DUNGEON)
...
object EditMode {
    ...
    fun getCurrentRoomPair() = Dungeon.dungeonTeammates[mc.thePlayer.name]?.getCurrentRoomPair()
