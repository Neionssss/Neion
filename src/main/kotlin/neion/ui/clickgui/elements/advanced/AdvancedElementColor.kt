 ...
 * @author Aton
 */
class AdvancedElementColor(parent: AdvancedMenu, module: Module, override val setting: ColorSetting): AdvancedElement(parent, module, setting) {
    ...
    override fun renderElement(mouseX: Int, mouseY: Int, partialTicks: Float) : Int{
        ...
        if (comboextended) {
            ...
            for (currentColor in setting.colors()) {
                ...
                TextUtils.drawString(currentColor.getName(), 1, ay + 2, -0x1)
                TextUtils.drawString(dispVal, settingWidth - TextUtils.getStringWidth(dispVal), ay + 2, -0x1)
                ...
                Gui.drawRect(0, (ay + 12), (percentage * settingWidth).toInt(), ay + 14, temp)
                if (percentage > 0 && percentage < 1) Gui.drawRect(
                    (percentage * settingWidth - 2).toInt(), ay + 12, ((percentage * settingWidth).toInt().coerceAtMost(settingWidth)), ay + 14, temp
                )
